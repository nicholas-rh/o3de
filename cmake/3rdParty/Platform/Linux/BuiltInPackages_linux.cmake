...
# platform-specific:
if (NOT LY_SYSTEM_PACKAGE_expat)
...
if (NOT LY_SYSTEM_PACKAGE_freetype)
...
if (NOT LY_SYSTEM_PACKAGE_libpng)
...
if (NOT LY_SYSTEM_PACKAGE_libsamplerate)
...
if (NOT LY_SYSTEM_PACKAGE_OpenEXR)
...
if (NOT LY_SYSTEM_PACKAGE_DirectXShaderCompilerDxc)
...
if (NOT LY_SYSTEM_PACKAGE_SQLite)
